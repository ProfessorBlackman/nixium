 ...
 */
export type Diagnostics = { core_version: string, kernel: string | null, capabilities: Snapshot, log_dir: string | null, config_dir: string | null, state_dir: string | null, logging_initialised: boolean, };
