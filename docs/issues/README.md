...
**Running against this machine** found twelve defects, and a fixture could not have found any of them — a fixture contains what its author expected, so if the expectation is wrong
