...
Sixty-four entries: **8 critical, 17 serious, 24 moderate, 15 friction**.

## The tally by finding mechanism

| Found by | Count | Note |
| --- | --- | --- |
| A gate in the toolchain (lint, clippy, budget, CI, a hook) | 14 | Cheapest possible — catches before any reasoning is needed |
