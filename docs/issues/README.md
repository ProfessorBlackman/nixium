...
| [05-concurrency-and-performance.md](05-concurrency-and-performance.md) | rayon, cancellation, scan cost and memory | 6 |
...
Thirty-nine entries: **3 critical, 11 serious, 14 moderate, 11 friction**.
...
| Running against this machine rather than a fixture | 8 | Wrong numbers, and 4.2 GiB of memory nobody had measured |
...
**Running against this machine** found eight defects, and a fixture could not have found any of them — a fixture contains what its author expected, so if the expectation is wrong
...
| **Scan memory: 4.2 GiB on a real home directory** | Raised as STO-19 at P0. The model holds a node per file; the depth cap does not bound it. See [05-concurrency-and-performance.md §4](05-concurrency-and-performance.md) |
